    ...
    <div class="form sectionBox horizontal">
        ...
        <section>
            <div class="form-element">
                <label for="db_name">{TR_SUBDOMAIN_NAME}</label>
                <div class="form-group">
                    <span>www.</span>
                    <input class="form-field" type="text" name="subdomain_name" id="subdomain_name" value="{SUBDOMAIN_NAME}">
                    <span class="sm">.</span>
