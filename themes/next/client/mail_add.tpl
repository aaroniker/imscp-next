    ...
    <div class="form sectionBox horizontal">
        ...
        <section>
            ...
            <div class="form-element">
                ...
                <input class="form-field" type="text" name="username" id="username" value="{USERNAME}">
            </div>
            <div class="form-element">
            ...
            <div id="tr_password" class="form-element">
                ...
                <input class="form-field pwd_generator pwd_prefill" type="password" name="password" value="" autocomplete="new-password" id="password">
            </div>
