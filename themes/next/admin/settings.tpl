<script>
    $(function() {
        ...
        $('.accordion > div:first-child').accordion({
            heightStyle: "content",
            collapsible: true,
            animated: 'slide',
...
<form action="settings.php" method="post" name="frmsettings" id="frmsettings">
    <div class="form sectionBox horizontal">
        ...
        <section class="accordion">
            <div>
                <div class="title">{TR_UPDATES}<span></span></div>
                <div class="content">
                ...
                <div class="title">{TR_LOSTPASSWORD}<span></span></div>
                <div class="content">
                    <div class="form-element">
                ...
                <div class="title">{TR_PASSWORD_SETTINGS}<span></span></div>
                <div class="content">
                    <div class="form-element">
                ...
                <div class="title">{TR_BRUTEFORCE}<span></span></div>
                <div class="content">
                    <div class="form-element">
                ...
                <div class="title">{TR_MAIL_SETTINGS}<span></span></div>
                <div class="content">
                    <div class="form-element">
                ...
                <div class="title">{TR_OTHER_SETTINGS}<span></span></div>
                <div class="content">
                    <div class="form-element">
